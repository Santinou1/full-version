...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-proxy': RouteRecordInfo<'apps-proxy', '/apps/proxy', Record<never, never>, Record<never, never>>,
    'apps-proxy-components-proxy-ip-table': RouteRecordInfo<'apps-proxy-components-proxy-ip-table', '/apps/proxy/components/ProxyIpTable', Record<never, never>, Record<never, never>>,
    'apps-proxy-components-proxy-locations': RouteRecordInfo<'apps-proxy-components-proxy-locations', '/apps/proxy/components/ProxyLocations', Record<never, never>, Record<never, never>>,
    'apps-proxy-components-proxy-response-time': RouteRecordInfo<'apps-proxy-components-proxy-response-time', '/apps/proxy/components/ProxyResponseTime', Record<never, never>, Record<never, never>>,
    'apps-proxy-components-proxy-stats': RouteRecordInfo<'apps-proxy-components-proxy-stats', '/apps/proxy/components/ProxyStats', Record<never, never>, Record<never, never>>,
    'apps-proxy-components-proxy-status': RouteRecordInfo<'apps-proxy-components-proxy-status', '/apps/proxy/components/ProxyStatus', Record<never, never>, Record<never, never>>,
